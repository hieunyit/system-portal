...
// @Accept json
// @Produce json
// @Param request body openvpndto.CreateUserRequest true "User creation data"
// @Success 201 {object} response.SuccessResponse
// @Failure 400 {object} response.ErrorResponse
// @Failure 409 {object} response.ErrorResponse
// @Router /api/openvpn/users [post]
func (h *UserHandler) CreateUser(c *gin.Context) {
	var req openvpndto.CreateUserRequest
...
// @Success 200 {object} openvpndto.UserResponse
...
// @Produce json
// @Param username path string true "Username"
// @Param request body openvpndto.UpdateUserRequest true "User update data"
...
func (h *UserHandler) UpdateUser(c *gin.Context) {
	...
	var req openvpndto.UpdateUserRequest
	if err := c.ShouldBindJSON(&req); err != nil {
...
// @Param request body openvpndto.ChangePasswordRequest false "Required only for change-password action"
// @Success 200 {object} response.SuccessResponse
// @Failure 400 {object} response.ErrorResponse
...
func (h *UserHandler) UserAction(c *gin.Context) {
	...
	case "change-password":
		...
		var req openvpndto.ChangePasswordRequest
		if err := c.ShouldBindJSON(&req); err != nil {
...
// @Success 200 {object} openvpndto.UserListResponse
// @Failure 400 {object} response.ErrorResponse
// @Router /api/openvpn/users [get]
func (h *UserHandler) ListUsers(c *gin.Context) {
	var filter openvpndto.UserFilter
	...
	userResponses := make([]openvpndto.UserResponse, len(users))
	...
	response := openvpndto.UserListResponse{
		Users:      userResponses,
		Total:      totalCount,
		Page:       filter.Page,
		Limit:      filter.Limit,
...
// @Success 200 {object} openvpndto.UserExpirationsResponse
// @Failure 400 {object} response.ErrorResponse
...
func (h *UserHandler) GetUserExpirations(c *gin.Context) {
	...
	if !includeExpired {
		filteredUsers := make([]openvpndto.UserExpirationInfo, 0)
...
func (h *UserHandler) validateUserFilter(filter *openvpndto.UserFilter) error {
	// Date validation
...
func (h *UserHandler) convertToEntityFilter(dtoFilter *openvpndto.UserFilter) *entities.UserFilter {
...
func (h *UserHandler) convertUserToResponse(user *entities.User) openvpndto.UserResponse {
	response := openvpndto.UserResponse{
...
func (h *UserHandler) buildFilterMetadata(filter *openvpndto.UserFilter) openvpndto.FilterMetadata {
	...
	return openvpndto.FilterMetadata{
...
// CRITICAL FIX: Validate auth method specific requirements
func (h *UserHandler) validateAuthSpecificRequirements(req *openvpndto.CreateUserRequest) error {
